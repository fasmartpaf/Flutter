...
class Colors {
  ...
  Color mainDarkColor = Color(0xFFFA7820);
  Color secondColor = Color(0xFF344968);
  Color secondDarkColor = Color(0xFFccccdd);
  Color accentColor = Color(0xFF6F7A89);
  Color accentDarkColor = Color(0xff8c8c9e);
  ...
  Color orangeColor = Color(0xFFFA7820);
  Color orangeColor_unrated = Color(0x46EE9355);
  Color buttonThemeColor = Color(0xFFFA7820);
  Color buttonThemeDardColor = Color(0xFFFA7820);
