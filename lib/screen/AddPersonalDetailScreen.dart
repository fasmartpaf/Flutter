...
class AddPersonalDetailScreenState extends State<AddPersonalDetailScreen> {
  ...
  AddProductBloc mBloc = AddProductBloc(LoadingState());
  BookingProductBloc bookingProductBloc = BookingProductBloc(LoadingState());
                      ...
                      child: Column(
                        ...
                        children: [
                         ...
                         /* Container(
                          ...
                          BlocProvider(
                              create: (BuildContext context) => AddProductBloc(LoadingState()),
