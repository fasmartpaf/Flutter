...
class MyBookingScreenState extends State<MyBookingScreen>
  ...
  BookingBloc mBloc = new BookingBloc(LoadingState());
  ReviewBloc reviewBloc = new ReviewBloc(LoadingState());
  ...
  void alert(Datum data) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return Dialog(
              child: BlocProvider(
                  create: (BuildContext context) => ReviewBloc(LoadingState()),
  ...
  void submit(Datum data) {
    ...
    if (value.isEmpty) {
      ...
      Navigator.of(context).pop();
      reviewBloc.add(AddReviewEvent(data.productId, rating1, value));
    }
  }
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocProvider(
        create: (BuildContext context) => BookingBloc(LoadingState()),
