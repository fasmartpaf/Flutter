...
class ProductDetailsWidgetState extends Hireleaptate<ProductDetailsWidget> {
  ProductDetailsBloc mBloc = ProductDetailsBloc(LoadingState());
  ...
  Widget build(BuildContext context) {
    ...
    return InheritedStateContainer(
        state: this,
        child: BlocProvider(
            create: (BuildContext context) => ProductDetailsBloc(LoadingState()),
