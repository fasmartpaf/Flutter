...
class FilterScreenState extends Hireleaptate<FilterScreen> {
  final _scaffoldKey = GlobalKey<ScaffoldState>();
  bool showProgress = false;
  List<DropDownItem> subCategoryList = [];
  List<DropDownItem> categoryList = [];
  List<DropDownItem> cityList = [];
  CategoryListBloc mCategoryBloc = CategoryListBloc(LoadingState());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider(
          create: (context) => CategoryListBloc(LoadingState()),
        ...
        children: [
          ...
          Container(
            ...
            child: RentorRaisedButton(
              ...
              onPressed: () {
                var arg=SearchEvent(queryString,selectedCategory.value,selectedSubCategory.value,selected==1?selectedCity.value:"","0",_priceValue.round().toString(),"0",selected==2?_distanceValue.round().toString():"",currentLocation);
