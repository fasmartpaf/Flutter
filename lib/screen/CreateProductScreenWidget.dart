...
class CreateProductScreenWidgetState extends State<CreateProductScreenWidget> {
  ...
  BookingProductBloc bookingBloc = BookingProductBloc(LoadingState());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        alignment: Alignment.topCenter,
                        child: Text(
                          isVerify?'Please wait till your profile is approved':'Please complete your profile to add/book products on rentors.',
                          textAlign: TextAlign.center,
                          style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
          ...
          body: BlocProvider(
              create: (BuildContext context) => CategoryListBloc(LoadingState()),
