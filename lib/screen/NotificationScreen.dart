...
class NotificationScreenScreenState extends Hireleaptate<NotificationScreen> {
  ...
  void initState() {
    ...
    super.initState();
    mBloc = NotificationBloc(LoadingState());
  ...
  Widget build(BuildContext context) {
    return InheritedStateContainer(
        ...
        child: Scaffold(
            body: BlocProvider(
                create: (BuildContext context) => NotificationBloc(LoadingState()),
