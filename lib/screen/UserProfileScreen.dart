...
class UserProfileScreenState extends Hireleaptate<UserProfileScreen> {
  ...
  OTPVerifiedBloc otpVerifiedBloc = OTPVerifiedBloc(LoadingState());
  ...
  void initState() {
    ...
    mBloc = UserDetailBloc(LoadingState());
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              'Your profile has been successfully submitted, it will be reviewed and approved/rejected within 12-24 hours subject to information provided by you. ',
                              textAlign: TextAlign.center,
                              style: TextStyle(
